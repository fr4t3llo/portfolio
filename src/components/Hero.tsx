...
export default function Hero() {
  return (
    <section className="flex flex-col items-center px-5 pt-14 pb-24 text-center sm:px-8 sm:pt-20 sm:pb-32">
      <PhoneSparkIcon className="size-[88px] text-accent sm:size-[112px]" />

      <h2 className="mt-10 font-serif text-display sm:mt-12">{profile.role}</h2>

      <p className="mt-6 max-w-[34ch] text-lead leading-relaxed text-balance text-muted">
        {profile.tagline}
      </p>

      <div className="mt-10 flex items-center gap-2.5 rounded-full sm:mt-12 border border-line bg-cream p-1.5 pl-4 shadow-[0_1px_2px_rgba(24,11,7,0.04)]">
